...
public class WeatherDatabaseHelper extends SQLiteOpenHelper {
    ...
    public static final String location_table = "CREATE TABLE " + WeatherContract.LocationEntry.TABLE_NAME + " (" + WeatherContract.LocationEntry._ID + " INTEGER PRIMARY KEY, " + WeatherContract.LocationEntry.LOCATION_CODE + " TEXT NOT NULL, " + LocationEntry.CITY_NAME + " TEXT NOT NULL, " + WeatherContract.LocationEntry.COORD_LAT + " REAL NOT NULL, " + LocationEntry.COORD_LONG + " REAL NOT NULL);";
    ...
    public static final String weather_table = "CREATE TABLE " + WeatherContract.WeatherEntry.TABLE_NAME + " (" + WeatherEntry._ID + " INTEGER PRIMARY KEY AUTOINCREMENT, " + WeatherEntry.LOCATION_ID + " INTEGER NOT NULL, " + WeatherEntry.DATE + " INTEGER NOT NULL, " + WeatherEntry.SHORT_DESCRIPTION + " TEXT NOT NULL, " + WeatherEntry.WEATHER_ID + " INTEGER NOT NULL, " + WeatherEntry.MIN_TEMP + " REAL NOT NULL, " + WeatherEntry.MAX_TEMP + " REAL NOT NULL, " + WeatherEntry.HUMIDITY + " REAL NOT NULL, " + WeatherEntry.PRESSURE + " REAL NOT NULL, " + WeatherEntry.WIND_SPEED + " REAL NOT NULL, " + WeatherEntry.DEGREES + " REAL NOT NULL, FOREIGN KEY (" + WeatherEntry.LOCATION_ID + ") REFERENCES " + LocationEntry.TABLE_NAME + " (" + LocationEntry._ID + "), UNIQUE (" + WeatherEntry.DATE + ", " + WeatherEntry.LOCATION_ID + "));";
