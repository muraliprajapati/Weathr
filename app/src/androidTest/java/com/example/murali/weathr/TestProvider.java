...
import com.example.murali.weathr.database.WeatherProvider;
...
public class TestProvider extends AndroidTestCase {
    ...
    static ContentValues[] createBulkInsertWeatherValues(long locationRowId) {
        ...
        for (int i = 0; i < BULK_INSERT_RECORDS_TO_INSERT; i++, currentTestDate += millisecondsInADay) {
            ...
            weatherValues.put(WeatherEntry.LOCATION_ID, locationRowId);
            weatherValues.put(WeatherContract.WeatherEntry.DATE, currentTestDate);
            weatherValues.put(WeatherContract.WeatherEntry.DEGREES, 1.1);
            weatherValues.put(WeatherContract.WeatherEntry.HUMIDITY, 1.2 + 0.01 * (float) i);
            weatherValues.put(WeatherContract.WeatherEntry.PRESSURE, 1.3 - 0.01 * (float) i);
            weatherValues.put(WeatherContract.WeatherEntry.MAX_TEMP, 75 + i);
            weatherValues.put(WeatherContract.WeatherEntry.MIN_TEMP, 65 - i);
            weatherValues.put(WeatherEntry.SHORT_DESCRIPTION, "Asteroids");
            weatherValues.put(WeatherContract.WeatherEntry.WIND_SPEED, 5.5 + 0.2 * (float) i);
    ...
    public void testGetType() {
        ...
        type = mContext.getContentResolver().getType(
                WeatherEntry.weatherWithLocationUri(testLocation));
        // vnd.android.cursor.dir/com.example.android.sunshine.app/weather
        ...
        type = mContext.getContentResolver().getType(
                WeatherEntry.weatherWithLocationAndDateUri(testLocation, testDate));
